...
func (a *Agent) DetectChosenTool(body models.ResponseBody, SystemMemory *models.SystemSettings, tools *[]models.ToolsHistory, msg []models.Message) (models.ResponseBody, error) {
	...
	switch FuncName {
	case "summarize":
		return models.ResponseBody{}, summarize(a, body)
	case "change_agent_settings":
		...
		*tools = append(*tools, tool)
		...
		if a.Queue != nil {
			resp, err = a.AskBack(msg, []models.Tool{})
			if err != nil {
				return models.ResponseBody{}, err
			}
		}
...
func summarize(a *Agent, body models.ResponseBody) error {
	var args models.SummarizeResponse
	if err := GetArgs(body, &args); err != nil {
		return err
	}
	emb, err := createEmbeddingFn(args.Text, a.Cfg)
	if err != nil {
		return err
	}
...
func (a *Agent) AskBack(msg []models.Message, tool []models.Tool) (models.ResponseBody, error) {
	respLLM, err := a.Queue.AddToQueue(llmcalls.QueueItem{Body: a.makeBody(msg, tool, "auto")})
	if err != nil {
		return models.ResponseBody{}, err
	}
	return respLLM, nil
...
func (a *Agent) makeBody(messages []models.Message, tools []models.Tool, ToolsChoise string) models.RequestBody {
